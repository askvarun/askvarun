...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        Now in order to get started, feel free to either execute the 'help' command or use the more user-friendly shortcuts at the bottom of screen.
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        ******************* CONTACT
        ==========================================================================
        let mob = +91-8860406501;
        let eMail = varun.gupta.zone;

        let facebook-URL = facebook.com/askvarun
        let twiter-URL = twitter.com/askvarun
        let llinkedin-URL = linkedin.com/in/askvarun
        let github-URL = github.com/askvarun

        let skype-id = askvarun

        ==========================================================================
        ******************* End of File
        `,
        "facebook.txt": "https://www.facebook.com/askvarun",
        "twitter.txt": "https://twitter.com/askvarun",
        "github":"https://github.com/askvarun",
        "linkedin":"https://www.linkedin.com/in/askvarun/"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
